...
本指南将详细介绍 DeEarthX-CE 的使用方法，包括基本操作、整合包转换、模板管理和高级功能。
...
**功能说明**：自动测试下载链接速度，选择最快的链接

**使用场景**：从模板商店下载模板时，系统会自动测试多个下载链接的速度，确保下载速度最优

### 实时进度显示

**功能说明**：显示操作的实时进度和状态

**使用场景**：所有操作（上传、处理、下载）都有实时进度显示，可以查看当前操作的详细进度和状态